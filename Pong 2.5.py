...
#-------------------MatchPoint---------------------------
	...
	if Intro == False:
		...
		textpos.centery = constants.SCREEN_HEIGHT*1/4
		screen.blit(text, textpos)
		
		font = pygame.font.Font(None, 55)
		text = font.render("(Table Tennis Simulator)", 1, constants.BLACK)
		textpos = text.get_rect()
		textpos.centerx = constants.SCREEN_WIDTH/2
		textpos.centery = constants.SCREEN_HEIGHT*3/7
		screen.blit(text, textpos)		
			
		
		font = pygame.font.Font(None, 65)
		text = font.render("[G] - 2-player         [T] - Single-player", 1, constants.BLACK)
		textpos = text.get_rect()
		textpos.centerx = constants.SCREEN_WIDTH/2
	...
	if score1 == 0 and score2 == 0 and style == 0 and Intro == True:
		...
		text = font.render("1-Random (entre 3 e 8)| 2-The first to reach 5 | 3-Classic", 1, constants.BLACK)
		textpos = text.get_rect()
		textpos.centerx = constants.SCREEN_WIDTH /2 
		textpos.centery = (constants.SCREEN_HEIGHT+150)/2
		screen.blit(text, textpos)
